...
GITHUB_SEARCH_QUERIES = [
    # Week 1 (light theme)
    ["AI agent framework stars:>50", "LLM tool use stars:>50", "MCP server stars:>50", "RAG application stars:>50"],
    # Week 2
    ["machine learning pipeline stars:>50", "vector database stars:>50", "fine tuning LLM stars:>50", "prompt engineering stars:>50"],
    # Week 3
    ["computer use agent stars:>50", "AI code generation stars:>50", "embedding model stars:>50", "open source LLM stars:>50"],
    # Week 4
    ["deep learning framework stars:>50", "AI safety alignment stars:>50", "transformer architecture stars:>50", "distributed training stars:>50"],
    # Week 5
    ["multi modal AI stars:>50", "reinforcement learning stars:>50", "AI testing evaluation stars:>50", "knowledge graph stars:>50"],
]


def _get_week_index() -> int:
    """Get rotation index based on day of year to cycle queries weekly."""
    from datetime import datetime, timezone
